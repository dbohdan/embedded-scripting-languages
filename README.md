...
| [SquiLu](https://github.com/mingodad/squilu) | C++ | Ref. counting | MIT | A fork of [Squirrel](http://squirrel-lang.org/)  that accepts a subset of javascript and C/C++, and extend it with more lua features like pattern matching, global table manipulation functions, a collection of useful extensions like sqlite3. |
