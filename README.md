...
| Scheme | [Wile](https://github.com/aalpar/wile) | Go | Go&#39;s GC | Apache-2.0 | R7RS. Pure Go, no CGo. Bytecode compiler and stack-based VM. Hygienic macros ([sets of scopes](https://www.cs.utah.edu/plt/scope-sets/)), first-class continuations, numeric tower. [Embedding API](https://pkg.go.dev/github.com/aalpar/wile). |
