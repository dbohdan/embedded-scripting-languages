...
| [Dhall](https://github.com/dhall-lang/dhall-lang/wiki/How-to-integrate-Dhall) | Haskell | Haskell's GC | 3-clause BSD | A functional configuration language.  Not Turing-complete.  Untrusted code: can't access the file system, can fetch Dhall libraries over HTTP(S) from static URLs (but libraries aren't allowed to access your data), can use up memory and CPU time for a DoS attack. |
