...
| Project name/link | Implementation language | GC | Language Type | Type System | License | Notes |
|-------------------|-------------------------|----|---------------|-------------|---------|-------|
| [AbcDatalog](http://abcdatalog.seas.harvard.edu/) | Java | JVM's GC | Declarative Logic | | 3-clause BSD | Implements Datalog. |
| [AngelScript](http://www.angelcode.com/angelscript/) | C++ | Ref. counting + cycle-detecting tracing GC | Object Oriented | Static | zlib | A statically typed curly brace language resembling C++ itself. |
| [Anko](https://github.com/mattn/anko/) | Go | Go's GC | | | MIT | Scriptable interpreter with syntax similar to Go. |
| [ArkScript](https://github.com/SuperFola/Ark) | C++ | None (resource release is destruction + optional manual MM) | Functional | Dynamic | MPL 2.0 | A small functional Lisp-like programming language. Separate bytecode compiler and VM. |
| [Atlast](https://www.fourmilab.ch/atlast/) | C | None (manual MM) | | | Public domain | A dialect of Forth originally developed at Autodesk. |
| [BeanShell](https://github.com/beanshell/beanshell/) | Java | JVM's GC | Object Oriented | Static | Apache License 2.0 | An small, embeddable Java source code interpreter. Understands Java code with certain extensions like method closures. |
| [Boron](http://urlan.sourceforge.net/boron/) | C | Tracing | Prototype-based | | LGPL 3+ | An embeddable scripting language similar to Rebol. |
| [Cascalog](https://github.com/nathanmarz/cascalog) | Clojure or Java | JVM's GC | Declarative Logic | | Apache License 2.0 | Implements Datalog. |
| [CircuitPython](https://github.com/adafruit/circuitpython) | C | Tracing | Object Oriented | Dynamic | MIT | A fork of MicroPython, designed for API uniformity across many microcontrollers. |
| [ChaiScript](http://chaiscript.com/) | C++ | Ref. counting | | | 3-clause BSD | A header-only C++14 interpreter library. |
| [Chibi Scheme](https://github.com/ashinn/chibi-scheme) | C | Tracing | Functional + Procedural | Dynamic | 3-clause BSD | Implements R7RS small. |
| [CHICKEN Scheme](https://call-cc.org/) | C | Tracing | Functional + Procedural | Dynamic | 3-clause BSD | Implements R5RS (with some [changes](http://wiki.call-cc.org/man/4/Supported%20language)). R7RS support is a work in progress. [Examples of embedding CHICKEN](https://wiki.call-cc.org/embedding). |
...
| [Datalog](https://github.com/c-cube/datalog) (c-cube) | OCaml | OCaml's GC | Declarative Logic | | 2-clause BSD | Implements Datalog. |
| [Datalog](https://github.com/fogfish/datalog) (fogfish) | Erlang | None (no collection inside interpreter state) | Declarative Logic | | Apache License 2.0 | Implements Datalog. |
| [Datalog](http://datalog.sourceforge.net/) (MITRE Corporation) | C | Tracing (Lua's GC) | Declarative Logic | | LGPL 2+ | Implements Datalog. It is implemented on top of Lua 5.3 and can be extended with Lua functions. |
| [Dhall](https://dhall-lang.org/) | Haskell | Haskell's GC | Functional | Static | 3-clause BSD | A statically-typed functional configuration language.  Not Turing-complete.  Untrusted code: can't access the file system, can fetch Dhall libraries over HTTP(S) from static URLs (but libraries aren't allowed to access your data), can use up memory and CPU time for a DoS attack.  Has a work-in-progress Clojure and Ruby implementation. |
| [Duktape](http://duktape.org/) | C | Ref. counting + cycle-detecting tracing GC | Object Oriented + Functional | Dynamic | MIT | Implements JavaScript E5/E5.1. |
| [DWScript](https://bitbucket.org/egrange/dwscript/) | Object Pascal (Delphi 2009 or later) | Ref. counting + cycle-detecting tracing GC | Object Oriented | Static | MPL 1.1, GPL 3 (JavaScript code generator) | [Description](https://www.delphitools.info/dwscript). A statically typed Delphi/Free Pascal-like language. Can compile to JavaScript. |
| [Dyon](https://github.com/pistondevelopers/dyon) | Rust | None (Rust-style [lifetimes](http://www.piston.rs/dyon-tutorial/lifetimes.html)) | Imperitive with [ad-hoc types](https://www.piston.rs/dyon-tutorial/ad-hoc-types.html) | Dynamic + Optional Static | Apache License 2.0 or MIT | Has optional, optimistic (succeed-by-default) static type checking. |
