...
| [BeanShell](https://github.com/beanshell/beanshell/) | Java | None | Apache License 2.0 | A small, free, embeddable Java source interpreter with object scripting language features |
...
| [JRuby](http://jruby.org/) | Java | JVM's GC | EPL/GPL/LGPL | JRuby, an implementation of Ruby on the JVM |
...
| [Lemon](https://github.com/lemon-lang/lemon/) | C | Tracing | MIT | Lemon is open source, embeddable, lightweight programming language |
